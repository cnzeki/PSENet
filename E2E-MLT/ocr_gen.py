...
def generator(batch_size=4, train_list='/home/klara/klara/home/DeepSemanticText/resources/ims2.txt', in_train=True,
              rgb=False, norm_height=32):
        ...
        for i in index:
            try:
                ...
                if image_name.find('/chinese_0/') != -1:
                    im = cv2.rotate(im,
                                    cv2.ROTATE_90_COUNTERCLOCKWISE)  # horizontal chinese text
